...
class Config:
    ...
    cls_threshold: float = 0.5           # min cos(CLS_crop, CLS_exemplar) to re-identify
    ...
    border_mode: str = "proto"           # proto | otsu | static (per-leaf border refine)
    ...
    # --- acceptance ---
    accept_mode: str = "cls"             # cls | proto | both
    accept_proto_threshold: float = 0.5  # min mean prototype sim when accept_mode in {proto, both}
