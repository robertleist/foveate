...
WHERE step (shared with the main method for a fair ablation):
    ...
    :func:`foveate.pipeline.run` and the root of :func:`foveate.cascade.foveate_cascade` use to
    ...
    individuation / merge / watershed after the gate) and we do NOT call ``foveate_cascade``
